    ...
    <TabOneStack.Navigator>
      <TabOneStack.Screen
        ...
        options={{
          ...
          headerLeft: () => (
            <ProfilePicture size={40} image={'https://instagram.fbtz1-3.fna.fbcdn.net/v/t51.2885-19/s150x150/39871828_397519727447244_6140278751818153984_n.jpg?_nc_ht=instagram.fbtz1-3.fna.fbcdn.net&_nc_ohc=rzbyrV88mL0AX_dsrXa&tp=1&oh=4225c944e1d2b1ad801f892359f65f72&oe=600A504F'} />
          )
        }}
      />
    </TabOneStack.Navigator>
